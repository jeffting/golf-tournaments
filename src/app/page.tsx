        ...
        <Box sx={{
          ...
          <Container maxWidth="lg" sx={{ px: { xs: 3, sm: 4, md: 4 } }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, flexWrap: 'wrap' }}>
              ...
              >
                <Typography sx={{ color: 'white', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', fontSize: '1.1rem', fontFamily: 'var(--font-bebas-neue)' }}>
              ...
              >
                ...
                <Typography sx={{ color: '#14532d', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', fontSize: '1.1rem', fontFamily: 'var(--font-bebas-neue)' }}>
                  Create a Tournament
                </Typography>
              </Box>
            </Box>
